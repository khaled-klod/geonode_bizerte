...
try:
    from sig_bizerte.local_settings import *
...
#
PROJECT_NAME = 'sig_bizerte'

# add trailing slash to site url. geoserver url will be relative to this
if not SITEURL.endswith('/'):
    SITEURL = '{}/'.format(SITEURL)

SITENAME = os.getenv("SITENAME", 'sig_bizerte')
...
CREATE_LAYER = strtobool(os.getenv('CREATE_LAYER', 'False'))